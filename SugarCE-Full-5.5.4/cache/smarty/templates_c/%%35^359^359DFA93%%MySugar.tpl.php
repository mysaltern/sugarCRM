<?php /* Smarty version 2.6.11, created on 2020-12-24 18:00:33
         compiled from include/MySugar/tpls/MySugar.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'include/MySugar/tpls/MySugar.tpl', 63, false),array('function', 'sugar_getimagepath', 'include/MySugar/tpls/MySugar.tpl', 93, false),array('function', 'counter', 'include/MySugar/tpls/MySugar.tpl', 106, false),)), $this); ?>
<?php echo '
<style>
.menu{
	z-index:100;
...
" onclick="return SUGAR.mySugar.showDashletsDialog();"/><?php endif; ?>
	 		<a href='index.php?module=Administration&action=SupportPortal&view=documentation&version=<?php echo $this->_tpl_vars['sugarVersion']; ?>
...
_div" style="display:none;">
	...
	<div id="dashletsDialog" style="display:none;">
		<div class="hd" id="dashletsDialogHeader"><a href="#" onClick="javascript:SUGAR.mySugar.closeDashletsDialog();">
			<div class="closedashlet">&nbsp;</div></a><?php echo $this->_tpl_vars['lblAddDashlets']; ?>
