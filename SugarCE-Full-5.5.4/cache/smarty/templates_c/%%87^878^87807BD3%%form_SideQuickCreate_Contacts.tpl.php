<?php /* Smarty version 2.6.11, created on 2020-12-24 17:59:26
         compiled from cache/modules/Contacts/form_SideQuickCreate_Contacts.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Contacts/form_SideQuickCreate_Contacts.tpl', 35, false),array('function', 'counter', 'cache/modules/Contacts/form_SideQuickCreate_Contacts.tpl', 40, false),array('function', 'sugar_translate', 'cache/modules/Contacts/form_SideQuickCreate_Contacts.tpl', 44, false),array('modifier', 'default', 'cache/modules/Contacts/form_SideQuickCreate_Contacts.tpl', 41, false),)), $this); ?>
...
<input tabindex="103"  type="text" name="emailAddress0" size=20><input tabindex="103"  type="hidden" name="emailAddressPrimaryFlag" value="emailAddress0"><input tabindex="103"  type="hidden" name="useEmailWidget" value="true"><script language="Javascript">addToValidate("form_SideQuickCreate_Contacts", "emailAddress0", "email", false, SUGAR.language.get("app_strings", "LBL_EMAIL_ADDRESS_BOOK_EMAIL_ADDR"));</script>
</tr>
<tr>
<td valign="top" width='75%' >
...
addToValidate(\'form_SideQuickCreate_Contacts\', \'full_name\', \'fullname\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'Contacts'), $this); echo '\' );
...
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'form_SideQuickCreate_Contacts_assigned_user_name\']={"form":"form_SideQuickCreate_Contacts","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};</script>'; ?>
