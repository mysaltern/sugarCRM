<?php /* Smarty version 2.6.11, created on 2020-12-24 17:59:11
         compiled from include/SugarFields/Fields/Relate/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugarvar', 'include/SugarFields/Fields/Relate/EditView.tpl', 37, false),)), $this); ?>
{*
/*********************************************************************************
...
>
<input type="hidden" name="<?php echo smarty_function_sugarvar(array('key' => 'id_name'), $this);?>
" id="<?php echo smarty_function_sugarvar(array('key' => 'id_name'), $this);?>
...
, "single", true);' <?php if (isset ( $this->_tpl_vars['displayParams']['javascript']['btn'] )):  echo $this->_tpl_vars['displayParams']['javascript']['btn'];  endif; ?>>
...
.value = '';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}" <?php if (isset ( $this->_tpl_vars['displayParams']['javascript']['btn_clear'] )):  echo $this->_tpl_vars['displayParams']['javascript']['btn_clear'];  endif; ?>>
